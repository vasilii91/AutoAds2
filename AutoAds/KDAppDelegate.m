...
//    [MainController sharedController].mainMenuController = mmvc;
//    [self.window setRootViewController:[MainController sharedController].mainMenuController];
//    
//    self.window.backgroundColor = [UIColor autoGray];
